...
# Préparer les positions des labels
# On met le texte légèrement en dehors du rayon max
...
# Layer pour les heures
vl |> @vlplot(
    layer = [
        vl,
        label_df |>
        @vlplot(
            mark = { :text, align = "center", baseline = "middle", dx=0, dy=-10 },
            encoding = {
                theta = {
                    field = :hour,
                    type = :quantitative,
