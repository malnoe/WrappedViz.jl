...
colors = rand(n)
labels = top10.text                # textes à afficher

# -----------------------
# Jitter pour éviter le chevauchement
# (proportionnel à la taille des bulles)
# -----------------------
...
text!(
    ax,
    labels;
    position = Point2f.(x_jittered, y_jittered),
    align = (:center, :center),
    fontsize = 12,
    color = :black
)
